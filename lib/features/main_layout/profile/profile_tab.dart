  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        CustomDropDownButton(label: appLocalizations!.theme,selectedItem: appLocalizations.light,menuItems: [appLocalizations.light, appLocalizations.dark],),
        SizedBox(height: 16.h,),
        CustomDropDownButton(label: appLocalizations.language,selectedItem: "English",menuItems: ["English", "Arabic"],)
